...
parentoutput_dir="/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/metaboanalyst/testlive_xmsPANDApls_v1.0.3.1_2/",
...
num_replicates = 1,
    ...
    rsd.filt.list = seq(0, 10, 5), pairedanalysis = FALSE, featselmethod="pls",
    ...
    heatmap.col.opt="RdBu",sample.col.opt="rainbow",alphacol=0.3,pls_vip_thresh=1, pls_ncomp=2,pca.stage2.eval = TRUE, scoreplot_legend=TRUE,num_nodes=4)
