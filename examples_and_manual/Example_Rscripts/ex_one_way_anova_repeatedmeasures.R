...
#load xmsPANDA v1.0.7.3
library(xmsPANDA)

feature_table_file<-"/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/git/xmsPANDA_v1.0.7.2/examples_and_manual/Example_feature_table_and_classlabels/feature_table_one_or_two_factor_analysis.txt"
class_labels_file<-"/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/git/xmsPANDA_v1.0.7.2/examples_and_manual/Example_feature_table_and_classlabels/classlabels_one_factor_repeatedmeasures.txt"



class_labels_file<-"/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/git/xmsPANDA_v1.0.7.2/examples_and_manual/Example_feature_table_and_classlabels/classlabels_2TP.txt"

outloc<-"~/Downloads/testpandav1.0.7.3onewayrepeat2TPB/"

source("/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/xmsPANDA_v1.0.6.37.R")

Xmat<-read.table(feature_table_file,sep="\t",header=TRUE)
...
demetabs_res<-diffexp(
        ...
        pairedanalysis = TRUE, featselmethod=c("ttestrepeat","lm1wayanovarepeat","limma1wayrepeat","spls1wayrepeat"),pvalue.thresh=0.05,
        ...
        max_varsel = 5, pls_ncomp = 5,pred.eval.method="BER",rocfeatlist=seq(2,10,1),
