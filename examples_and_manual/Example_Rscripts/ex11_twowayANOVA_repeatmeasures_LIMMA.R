...
demetabs_res<-diffexp(feature_table_file="/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/metaboanalyst/feature_table_time_series_twoTimePoints.txt",
...
class_labels_file="/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/metaboanalyst/cress_time_and_group_classlabels_limma2wayanovarepeat.txt",
num_replicates = 1,
...
rsd.filt.list = c(-1), pairedanalysis = TRUE, featselmethod="limma2wayrepeat",
fdrthresh = 0.05, fdrmethod="none",cor.method="spearman", abs.cor.thresh = 0.5, cor.fdrthresh=0.2,
