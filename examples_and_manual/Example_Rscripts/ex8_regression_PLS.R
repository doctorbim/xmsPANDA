...
#Ex8: Regression using partial least squares (PLS)
library(xmsPANDA)
...
parentoutput_dir="/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/metaboanalyst/testlive_xmsPANDAplsreg/",
...
num_replicates = 1,
    ...
    rsd.filt.list = seq(0, 30, 5), pairedanalysis = TRUE, featselmethod="pls", 
    ...
    samplermindex=NA,numtrees=1000,analysismode="regression",net_node_colors=c("green","red"), net_legend=FALSE,
    heatmap.col.opt="RdBu",sample.col.opt="rainbow",alphacol=0.3,pls_vip_thresh=1, pls_ncomp=2, max_rf_varsel=100) 
