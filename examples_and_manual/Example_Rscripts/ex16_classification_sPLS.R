...
parentoutput_dir="/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/metaboanalyst/testlive_xmsPANDApls/",
...
num_replicates = 1,
    ...
    rsd.filt.list = seq(0, 10, 5), pairedanalysis = FALSE, featselmethod="spls", 
    ...
    heatmap.col.opt="RdBu",sample.col.opt="rainbow",alphacol=0.3,max_rf_varsel=100,pls_vip_thresh=1, pls_ncomp=2) 
