...
parentoutput_dir="/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/metaboanalyst/testlive_xmsPANDAv0.0.6_fdr0.5_lm2wayanovaclass_v0.0.1_6/",
...
num_replicates = 1,
    ...
    rsd.filt.list = seq(0, 30, 5), pairedanalysis = FALSE, featselmethod="lm2wayanova", 
