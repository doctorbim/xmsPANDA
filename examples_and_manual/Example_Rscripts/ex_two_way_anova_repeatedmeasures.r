...
class_labels_file<-"/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/git/xmsPANDA_v1.0.7.2/examples_and_manual/Example_feature_table_and_classlabels/classlabels_two_factor_repeatedmeasures.txt"


outloc<-"~/Downloads/testpandav1.0.7.3twowayrepeat/"
