...
res<-get_classification.accuracy(kfold=kfold,featuretable=featuretable,classlabels=classlabels,classifier="plsda",testfeaturetable=testfeaturetable,testclasslabels=testclasslabels,errortype="BAR",kernelname="linear")
