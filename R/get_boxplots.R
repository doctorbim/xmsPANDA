get_boxplots <-
function(X=NA,Y=NA,feature_table_file,parentoutput_dir,class_labels_file,boxplot.col.opt="grey57",sample.col.opt="rainbow",alphacol=0.3,newdevice=TRUE,cex=0.6,replace.by.NA=FALSE,pairedanalysis=FALSE,filename="")
{
